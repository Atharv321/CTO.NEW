.PHONY: help build test up down clean migrate rollback logs install lint type-check start
...
help:
    ...
    @echo "  make start         - Start services with migration"
    ...
    @echo "  make lint          - Run linting across monorepo"
